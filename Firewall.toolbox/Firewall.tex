...
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Address \.{\defeq} [ ip \.{:} Nat ,\, port \.{:} Nat ]}%
\@y{\@s{0}%
 address has port and \ensuremath{ip
}}%
\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A \ensuremath{Packet} has a source and destination address,
 and a protocol
\end{cpar}%
\end{lcom}%
\@x{ Packet\@s{4.1} \.{\defeq} [ source \.{:} Address ,\,}%
\@x{\@s{55.73} dest \.{:} Address ,\,}%
\@x{\@s{55.73} protocol \.{:} Protocols ]}%
\@pvspace{8.0pt}%
\@x{ Rule \.{\defeq} [ Packet \.{\rightarrow} {\BOOLEAN} ]}%
\@y{\@s{0}%
 A \ensuremath{Rule} maps from packets to boolean values
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} forwarded \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ Reject ( p ) \.{\defeq}}%
\@x{\@s{16.4} \E\, rule \.{\in} AcceptList \.{:}}%
\@x{\@s{27.72} \.{\land} rule [ p ]}%
\@x{\@s{27.72} \.{\land} forwarded \.{'} \.{=} forwarded \.{\cup} \{ p \}}%
\@pvspace{8.0pt}%
\@x{ Accept ( p ) \.{\defeq}}%
\@x{\@s{16.4} \E\, rule \.{\in} RejectList \.{:}}%
\@x{\@s{27.72} \.{\land} rule [ p ]}%
\@x{\@s{27.72} \.{\land} {\UNCHANGED} forwarded}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, packet \.{\in} Packet \.{:}}%
\@x{\@s{27.72} \.{\lor} Reject ( packet )}%
\@x{\@s{27.72} \.{\lor} Accept ( packet )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 16 12:22:12 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Feb} 13 18:27:34
 \ensuremath{GMT} 2021 by \ensuremath{alunm
}%
\end{cpar}%
\end{lcom}%
\end{document}
